      ...
      <div className="cards-row">
        ...
        <div className="card upcoming">
          ...
          <div className="up-item">
            Figma - Monthly <span className="muted">$150</span>
          </div>
          <div className="up-item">
            Adobe - Yearly <span className="muted">$559</span>
          </div>
        </div>
      </div>
                ...
                <li key={l.id} className="loan-item">
                  <div className="loan-left">
                    ...
                    <div className="loan-meta">
                      Remaining: ${l.remaining} • Rate: {l.rate}%
                    </div>
                  </div>
                  <div className="loan-actions">
                    ...
                    <button
                      className="btn"
                      onClick={() => {
                        const amt = Number(payAmount[l.id] || 0);
                        if (amt > 0) onPay(l.id, amt);
                        setPayAmount((prev) => ({ ...prev, [l.id]: "" }));
                      }}
                    >
                      Pay
                    </button>
